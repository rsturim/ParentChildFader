...
This is a simple image fader plugin much in the spirit of what you can find with the "jQuery Cycle":http://jquery.malsup.com/cycle/ plugin -- except this implementation allows author to define parents with corresponding children.
